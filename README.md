...
| [Convolution from equations](docs/README.md#convolution-from-equations-in-progress) | Capability probes and a `conv2d`-checked reference; the demo ladder is queued | **In progress** |
