...
most `max_read_bytes` and independent of total file size. For tensors larger
than a useful single-slice budget, the separate
[bounded statistics demo](safetensors-statistics.md) performs repeated aligned
reads.
